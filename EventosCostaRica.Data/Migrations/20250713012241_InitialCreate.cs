...
namespace EventosCostaRica.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventoDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlockedSeats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlockedSeats_Eventos_EventoId",
                        column: x => x.EventoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlockedSeats_EventoId_SeatRow_SeatColumn",
                table: "BlockedSeats",
                columns: new[] { "EventoId", "SeatRow", "SeatColumn" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Boletos_EventoId_SeatRow_SeatColumn",
                table: "Boletos",
                columns: new[] { "EventoId", "SeatRow", "SeatColumn" },
                unique: true);
